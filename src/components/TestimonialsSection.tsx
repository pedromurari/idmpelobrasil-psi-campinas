  ...
  const testimonials = [
    {
      ...
      quote: "A psicanalise transformou completamente minha visao sobre mim mesmo.",
    },
    {
      id: 2,
      name: "Participante IDM",
    ...
    },
    {
      ...
      quote: "Descobri camadas de mim mesmo que eu nem sabia que existiam.",
    },
    {
      id: 4,
      name: "Participante IDM",
